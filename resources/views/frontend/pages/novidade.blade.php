...
<section class="featured-properties-area section-padding-100-50">
    <div class="container">
        ...
        <div class="row">
            @forelse ( $novaMobiliario as $produtoItem)
                <div class="col-12 col-md-6 col-xl-4">
                    <div class="single-featured-property mb-50">
                        <!-- Property Thumbnail -->
                        <div class="property-thumb">
                            @if ($produtoItem->imobiliarioImages->count() > 0)
                            <a  href="{{url('/colecao/'.$produtoItem->categoria->nome.'/'.$produtoItem->nome)}}">
                                <img src="{{ asset($produtoItem->imobiliarioImages[0]->image)}}" alt="{{$produtoItem->nome}}">
                            </a>
                            @endif
                        ...
                        <div class="property-content">
                            ...
                            <p class="location"><img src="../assets/icons/location.png" alt="">{{$produtoItem->local}}</p>
                            <p>{{$produtoItem->p_discricao}}</p>
